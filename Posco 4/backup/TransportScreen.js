  ...
  return (
    ...
    >
      ...
      <View style={styles.controls}>
        ...
        />
        <Button mode="contained" onPress={useCurrentLocation} style={styles.currentLocationButton}>
          Your position
        </Button>
        {currentAddress ? (
        ...
        <Button mode="contained" onPress={confirmActivity} style={styles.confirmButton}>Confirm Activity</Button>
      </View>
    </KeyboardAvoidingView>
  );
};
